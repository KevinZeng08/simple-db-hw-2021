...
public class SeqScan implements OpIterator {
    ...
    public TupleDesc getTupleDesc() {
        ...
        // create a new TupleDesc, add tableAlias as prefix for all fieldName
        int numFields = original.numFields();
        Type[] typeAr = new Type[numFields];
        String[] fieldAr = new String[numFields];
        int idx = 0;
        Iterator<TupleDesc.TDItem> it = original.iterator();
        while(it.hasNext()) {
        ...
        TupleDesc prefixed = new TupleDesc(typeAr,fieldAr);
        return prefixed;
    }
